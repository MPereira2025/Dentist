...
public class TurnoJpaController implements Serializable {
    ...
    public void create(Turno turno) {
        ...
        try {
            ...
            em.persist(turno);
            if (odonto != null) {
                odonto.getListTurno().add(turno);
                odonto = em.merge(odonto);
            }
            if (pacien != null) {
                pacien.getListTurno().add(turno);
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            Odontologo odonto = turno.getOdonto();
            if (odonto != null) {
                odonto.getListTurno().remove(turno);
                odonto = em.merge(odonto);
            }
            Paciente pacien = turno.getPacien();
            if (pacien != null) {
                pacien.getListTurno().remove(turno);
                pacien = em.merge(pacien);
            }
            em.remove(turno);
            em.getTransaction().commit();
