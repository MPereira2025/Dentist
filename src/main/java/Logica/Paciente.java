...
public class Paciente extends Persona implements Serializable{
    ...
    public Paciente(boolean tieneOS, String typeBlood, Responsable anResponsable, List<Turno> listTurno, int id, String ci, String name, String lastname, int tel, String adresss, Date dateborn) {
        super(id, ci, name, lastname, tel, adresss, dateborn);
